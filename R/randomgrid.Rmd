...
for (k in c("safety","kobe.p","yield","yieldAav")) {
  ...
  pairwise1[[k]] =ggplot(subset(pairwise, objective==k)) + 
    ...
    scale_fill_distiller("",palette="Spectral", na.value="white", direction=1,breaks=c(0.4,0.6,0.8)) + 
    #geom_contour(color = "white", alpha = 0.1) + 
...
if(k %in% c("kobe.p")){
  pairwise1[[k]] =ggplot(subset(pairwise, objective==k)) + 
    ...
    geom_contour(color = "white", alpha = 0.1) + 
    scale_fill_distiller("",palette="Spectral", na.value="white", direction=1, breaks=c(0.3,0.5,0.7)) + 
    #geom_contour(color = "white", alpha = 0.1) + 
  ...
  pairwise1[[k]] =ggplot(subset(pairwise, objective==k)) + 
    ...
    geom_tile() + 
    geom_contour(color = "white", alpha = 0.1) + 
    scale_fill_distiller("",palette="Spectral", na.value="white", direction=1, breaks=c(0.9,0.95)) + 
    #geom_contour(color = "white", alpha = 0.1) + 
